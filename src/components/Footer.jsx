...
export const Footer = () => {
  ...
  console.log(location, '123456789')
  return (
    <>
      {location.pathname === "/login" ? <> <hr className='hr-line' /> </> :
        <>
          <Banner />
          <Opening />
        </>
      ...
      <div class="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 ">
        ...
        <div class="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
          <div class="sm:col-span-2">
            ...
            <div class=" lg:max-w-sm">
              <a href="/" aria-label="Go home" title="Company" className='flex justify-center items-center md:justify-start' >
                ...
                <p class="ml-2 text-xl font-bold tracking-wide text-gray-800 uppercase">Company</p>
              </a>
          ...
          <div class="space-y-2 text-sm ">
            ...
            <div class="flex ">
              ...
              <a href="tel:850-123-5021" aria-label="Our phone" title="Our phone" class="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800">01870653599</a>
            </div>
            <div class="flex">
              <p class="mr-1 text-gray-800">Email:</p>
              <a href="mailto:info@lorem.mail" aria-label="Our email" title="Our email" class="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800">ma01776879@gmail.com</a>
            </div>
            <div class="flex">
        ...
        {/* //footer reserved part */}
        <div class="flex flex-col-reverse justify-between pt-2 pb-10 border-t lg:flex-row">
